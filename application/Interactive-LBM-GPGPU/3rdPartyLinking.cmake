...
elseif(WIN32)
    ...
    target_link_libraries(${targetName} "${CMAKE_SOURCE_DIR}/3rdparty/glfw-3.4.bin.WIN64/lib-vc2022/glfw3.lib")
    target_link_libraries(${targetName} "${CMAKE_SOURCE_DIR}/3rdparty/SDL2-2.30.0/lib/x64/SDL2.lib")

elseif(UNIX)


target_link_libraries(${targetName} "/usr/lib/x86_64-linux-gnu/libSDL2.so")
target_link_libraries(${targetName} "/usr/lib/x86_64-linux-gnu/libglfw.so")
endif()
